...
class AdapterPaciente(val fragment: ListaPacienteFragment) : RecyclerView.Adapter<AdapterPaciente.ViewHolderPaciente>() {
    ...
    class ViewHolderPaciente(itemView: View) : RecyclerView.ViewHolder(itemView),
        ...
        private val textViewNomePaci = itemView.findViewById<TextView>(R.id.textViewNomePaci)
        ...
        private val textViewNrUtente = itemView.findViewById<TextView>(R.id.textViewNrUtente)
        private val textViewAltura = itemView.findViewById<TextView>(R.id.textViewAltura)
        private val textViewPeso = itemView.findViewById<TextView>(R.id.textViewPeso)
        private val textViewDataNasci = itemView.findViewById<TextView>(R.id.textViewDataNasci)
        ...
        fun atualizaPaciente(paciente: Paciente) {
            ...
            textViewNomePaci.text = paciente.nome
            textViewMorada.text = paciente.morada
            textViewContacto.text = paciente.contacto
            textViewNrUtente.text = paciente.NrUtente
            textViewAltura.text = paciente.altura
            textViewPeso.text = paciente.peso
            textViewDataNasci.text = paciente.DataNascimento
        }
