...
class TabelaPaciente (db: SQLiteDatabase) {
    ...
    fun cria(){
        db.execSQL(
                "CREATE TABLE $NOME_TABELA (${BaseColumns._ID} INTEGER PRIMARY KEY AUTOINCREMENT, $CAMPO_MORADA TEXT NOT NULL ,$CAMPO_CONTACTO NUMERIC NOT NULL,$CAMPO_NR_UTENTE NUMERIC NOT NULL , $CAMPO_ALTURA NUMERIC NOT NULL,$CAMPO_PESO NUMERIC NOT NULL ,$CAMPO_DATA_NASCIMENTO DATE NOT NULL ,$NOME_PACIENTE TEXT NOT NULL)")
    }
